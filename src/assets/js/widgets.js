      ...
      (window.__twttr &&
        ...
        !(function(t) {
              ...
              (function() {
                ...
                function x(t, e) {
                  if (e.constructor === t.constructor) E(t, e);
                    ...
                    n === ot
                      ? I(t, ot.error)
                      : void 0 === n ? T(t, e) : o(n) ? _(t, e, n) : T(t, e);
                  }
                }
                  ...
                  (n._instanceConstructor = t),
                    ...
                    n._validateInput(e)
                      ? ((n._input = e),
                        ...
                        n._init(),
                        0 === n.length
                          ? T(n.promise, n._result)
                          : ((n.length = n.length || 0),
                            n._enumerate(),
                            0 === n._remaining && T(n.promise, n._result)))
                      : I(n.promise, n._validationError());
                }
                ...
                function z(t) {
                  ...
                  if (!Q(t))
                    return (
                      I(i, new TypeError("You must pass an array to race.")), i
                    );
                ...
                (L.prototype._enumerate = function() {
                  ...
                  (L.prototype._settledAt = function(t, e, n) {
                    var r = this,
                      i = r.promise;
                    i._state === nt &&
                      (r._remaining--, t === it ? I(i, n) : (r._result[e] = n)),
          ...
          function(t, e, n) {
            ...
            function s(t) {
              return (
                (t = t || v), /^Mozilla\/5\.0 \(Linux; (U; )?Android/.test(t)
              );
            }

            function u(t, e) {
              return (
                (t = t || p), (e = e || v), t.postMessage && !(i(e) && t.opener)
              );
            }
          ...
          function(t, e, n) {
            ...
            function i(t, e) {
              return (
                !!l ||
                (!!d.asBoolean(f.val("dnt")) ||
                  (!(!s || (1 != s.doNotTrack && 1 != s.msDoNotTrack)) ||
                    (!!c.isUrlSensitive(e || a.host) ||
                      (!(
                        !u.isFramed() ||
                        !c.isUrlSensitive(u.rootDocumentLocation())
                      ) ||
                        ((t = h.test(t || o.referrer) && RegExp.$1),
          ...
          function(t, e, n) {
            ...
            function s(t, e) {
              var n = {};
              return (
                (e = e || {}), (e.association_namespace = i(t)), (n[b] = e), n
              );
            }
          ...
          function(t, e, n) {
            ...
            function i(t, e) {
              ...
              b.isObject(t) &&
                b.isObject(e) &&
                ((i = w.flattenClientEventPayload(t, e)),
                (n = d.firstChild),
            ...
            function o(t, e, n) {
              ...
              r ||
                ...
                I.promise.then(function() {
                  i(
                    w.formatClientEventNamespace(t),
                    w.formatClientEventData(e, n)
                  );
                });
            }
            ...
            function a(t) {
              t.overrideProperty("id", {
                ...
                t.override("injectWidgetEl", function(t) {
                  ...
                  return this.initialized
                    ? this.widgetEl
                      ? y.reject(new Error("widget already injected"))
                      : c.write(function() {
          ...
          function(t, e, n) {
                  ...
                  .forEach(function(t) {
                    ...
                    r(function() {
                      t.setAttribute("width", i.width),
                        ...
                        y.present(t, "wvp-player-container")
            ...
            function l(t) {
              m.inlineStyle() ||
                (f(t, ".MediaCard-widthConstraint", "maxWidth", w),
